...
//               _aiSuggestionsOutputText.startsWith("Target Details")) {
//             _aiSuggestionsOutputText = "🤖 AI: $token";
//           } else {
...
//     } catch (e) {
//       print("❌ Failed to request default dialer status: $e");
//     }
//   }
...
//       }
//     } catch (e) {
//       print("❌ Error fetching queue ($filter): $e");
//       if (mounted) setState(() => _isLoadingQueue = false);
//     }
//   }
...
//   //   String backendHost = "10.193.173.248:8000";
//   //   try {
...
//   //   try {
//   //     final bool? success = await _telecomChannel.invokeMethod<bool>(
//   //       'makeNativeInternalCall',
//   //       {'phoneNumber': cleanNumber, 'isAiMode': _isAiCallingMode},
//   //     );
...
//     try {
//       // 1. Triggers the cellular call intent ONCE
//       final bool? success = await _telecomChannel.invokeMethod<bool>(
//         'makeNativeInternalCall',
//         {'phoneNumber': cleanNumber, 'isAiMode': _isAiCallingMode},
//       );

//       // 2. Mutes audio 2s later WITHOUT re-triggering the call intent
//       if (_isAiCallingMode) {
//         Future.delayed(const Duration(seconds: 2), () async {
//           try {
...
class _MainDialerContainerState extends State<MainDialerContainer> {
  ...
  Future<void> _executeCall(
    ...
    try {
      // 1. Launch Direct Cellular Call Intent
      ...
      // 2. Delayed AI Activation when Line Connects
      if (_isAiCallingMode) {
  ...
  // 🎨 Full In-Call Screen Display Widget
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // 💬 Live Customer & AI Speech-to-Text Transcript Feed
          Expanded(
            child: Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
          ...
          // 🔴 Hangup / End Call Control Button
          FloatingActionButton.large(
